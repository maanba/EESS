insert into Subject values(1, 'cs', 'dette er csharp', null, null, null, 'Y');
insert into Subject values(2, 'python', 'dette er python', 'Torben', 'A', null, 'Y');
insert into Subject values(3, 'Android', 'dette er android', 'peter', 'B', 'Y', 'Y');
insert into Subject values(4, 'GameDev', 'dette er gamedev', 'tobias', null, 'Y', 'Y');
insert into Subject values(5, 'SysDev', 'dette er sysdev', 'Torben', 'A', 'Y', 'N');
insert into Subject values(6, 'Java', 'dette er Java', 'tobias', 'B', 'Y', 'N');
insert into Subject values(7, 'C++', 'dette er c++', 'Peter', 'A', 'Y', 'N');
insert into Subject values(8, 'IOS', 'dette er IOS', 'tobias', 'B', 'Y', 'N');
...
insert into Student values(200, 'jonh hitler', 1, 4, 2, 3, 1, 2);
insert into Student values(201, 'Monty mus', 4, 2, 1, 3, 1, 2);
insert into Student values(202, 'James Bond', 2, 1, 3, 4, 1, 2);
